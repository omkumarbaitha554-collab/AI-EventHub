...
export default function CreateEventPage() {
  ...
  const handleAIGenerate = (generatedData) => {
    console.log("Applying generated data to form:", generatedData);
    ...
    if (generatedData.title) setValue("title", generatedData.title, options);
    if (generatedData.description) setValue("description", generatedData.description, options);
    if (generatedData.category) setValue("category", generatedData.category, options);
    if (generatedData.suggestedCapacity) setValue("capacity", generatedData.suggestedCapacity, options);
    if (generatedData.suggestedTicketType) setValue("ticketType", generatedData.suggestedTicketType, options);
